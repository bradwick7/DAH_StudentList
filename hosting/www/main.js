...
const routes = [
    ...
    {
        path: 'update-student',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_update-student_update-student_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./update-student/update-student.module */ 8902)).then((m) => m.UpdateStudentPageModule),
    },
    {
        path: 'login',
